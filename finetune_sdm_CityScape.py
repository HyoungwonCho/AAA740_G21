...
def main_worker(args):
    ...
    if args.do_train:
        ...
        if getattr(args, 'refer_clip_preprocess', None):
            ...
            train_dataset = BaseDataset(args, split='train') # video_root = "/media/data/HDTF_preprocessed/30_frame/HDTF/" kpt=잘해뒀음.. 잘.. @ config/ref_attn_clip_combine_controlnet/HDTF_kpt.py
