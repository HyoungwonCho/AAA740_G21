...
--cf config/ref_attn_clip_combine_controlnet/config_INIT_multi_metric_specific_samples.py \
--num_inference_steps 50 \
--guidance_scale 7.0 \
--root_dir visu/ --log_dir sampling/ \
--max_eval_samples 10000000 \
--pretrained_model /media/dataset/run_test_hw/Init/seg_edge_depth_resume/3999.pth \
--eval_visu \
--eval_class ${WEATHER} \
--eval_save_filename /media/dataset/instadiff/result/${WEATHER} \
