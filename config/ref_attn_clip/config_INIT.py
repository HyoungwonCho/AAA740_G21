...
#     inner_collect_fn,
# )
from config.ref_attn_clip.net_cont_INIT import (
    Net,
    inner_collect_fn,
)
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/INIT/dataset_init_dreambooth.py"
    ...
    # pretrained_model_path = "lambdalabs/sd-image-variations-diffusers"
