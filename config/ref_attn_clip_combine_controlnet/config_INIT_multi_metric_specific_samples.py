...
#     inner_collect_fn,
# )
from config.ref_attn_clip_combine_controlnet.net_cont_INIT_multi import (
    Net,
    inner_collect_fn,
)
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/dataset_init_multi_metric_specific_samples.py"
    ...
    frame_root = "/media/dataset/init_hw/image"
