...
from config import *
from config.ref_attn_clip_combine_controlnet_attr_pretraining.net_cont_gan_INIT_sampling_zecon import (
    Net,
    inner_collect_fn,
)
...
class Args(BasicArgs):
    ...
    Synthesia_root = "/media/data/i2i_dataset/Syntheia/sort/"
    Synthesia_annot_root = "/media/data/i2i_dataset/Syntheia/grsam_eval_masked/"
