...
from .diffusers_custom.unet_2d_blocks_custom import (
    AdaINDownBlock2D,
    CrossAttnUpBlock2D,
    DownBlock2D,
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (AdaINDownBlock2D, DownBlock2D, CrossAttnUpBlock2D, UpBlock2D)):
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(hidden_states=sample, temb=emb, style=style)
