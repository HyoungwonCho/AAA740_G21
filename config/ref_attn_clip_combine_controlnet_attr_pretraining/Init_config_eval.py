...
from config import *
from config.ref_attn_clip_combine_controlnet.net_cont_INIT_segedge import (
    Net,
    inner_collect_fn,
)
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/dataset_init_eval.py"
    ...
    CityScape_data_root = "/media/data/init_hw/image/"  # reference
    Synthesia_root = "/media/data/syn/sort/"  # label - condition의 rgb
    Synthesia_annot_root = "/media/data/syn/grsam_eval_masked/"  # condition
