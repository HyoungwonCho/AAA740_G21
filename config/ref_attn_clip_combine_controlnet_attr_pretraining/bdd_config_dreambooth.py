...
from config import *
from config.ref_attn_clip_combine_controlnet_attr_pretraining.net_without_controlnet import Net, inner_collect_fn
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/dataset_BDD100k.py"
    ...
    frame_root = "/media/data/bdd100k/images/100k/"
