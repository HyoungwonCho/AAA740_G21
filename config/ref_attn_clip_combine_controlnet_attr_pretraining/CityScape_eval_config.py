...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/dataset_CityScape_eval.py"
    ...
    CityScape_data_root = "/media/data/i2i_dataset/Cityscape/sort/"
    Synthesia_annot_root = (
        "/media/data/i2i_dataset/Syntheia/grsam_eval_masked/"  # SEYEON_EVAL_EDIT#
    )
