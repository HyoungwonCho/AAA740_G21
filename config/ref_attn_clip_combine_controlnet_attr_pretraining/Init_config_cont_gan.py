...
#     inner_collect_fn,
# )
from config.ref_attn_clip_combine_controlnet_attr_pretraining.net_cont_gan_INIT import (
    Net,
    inner_collect_fn,
)
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = "dataset/dataset_init.py"
    ...
    frame_root = "/media/data/init_hw/image"
