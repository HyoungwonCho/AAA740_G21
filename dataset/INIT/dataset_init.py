...
class BaseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            # Seg
            seg_image_name = img_name.replace("/image/", "/mask/")  # /media/dataset/init_hw/mask_only/sunny/sunny_0000.png
            seg_image_name = seg_image_name.replace(
                class_name, class_name + "_mask"
            )  # /media/dataset/init_hw/mask_only/sunny_mask/sunny_mask_0000.png
