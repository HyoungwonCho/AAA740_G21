...
class BaseDataset(Dataset):
    def __init__(self, args, split, debugging=False, preprocesser=None):
        ...
        if debugging:
            dataset_root = "/media/data/bdd10k_hw/*/images/*.jpg"
            self.img_size = (256, 256)
        else:
            self.args = args
            dataset_root = os.path.join(args.frame_root, "*.jpg")
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            cond_img_name = img_name.replace("/images/", "/cond/").replace("jpg", "png")  # /media/data/init_hw/cond/rainy/rainy_0123.png
            class_name = img_name.split("/")[4]  # daytime/night
